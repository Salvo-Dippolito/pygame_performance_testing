...
from .arenas import PiratePlunderArena, CTFArena, ABCArena, CalderaArena, TwoColoursArena
from .display import Display
from .arenas.TEST_sunny_side_up_arena import TEST_SunnySideUpArena
DEFAULT_GAME = 'caldera'

GAMES = {'caldera': CalderaArena,
         'pirate-plunder': PiratePlunderArena,
         'ctf': CTFArena,
         'sunny-side-up': TEST_SunnySideUpArena,
         'abc': ABCArena,
