...
from sr.robot.TEST_simulator import TEST_Simulator
...
sim = TEST_Simulator(config, background=False)


class RobotThread(threading.Thread):
    def __init__(self, zone, script_file, *args, **kwargs):
    ...
    def run(self):
        print("Executing script for zone:", self.zone)
        ...
        exec(script_content, {'Robot': robot})
# class RobotThread(threading.Thread):
